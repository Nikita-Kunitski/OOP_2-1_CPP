	...
	int       nCmdShow) // начальный вид окна
{
	...
	hWnd = CreateWindow("MyWindowClass", "MyWindow", WS_OVERLAPPEDWINDOW, 500, 300, 600, 450, NULL, NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
	{
		...
		wndSecondClass.lpszClassName = "MySecondClass";
		...
		TCHAR str[256];
		_itoa_s(freeBytes, str, sizeof(freeBytes));
	...
	case WM_RBUTTONDOWN:
	{
		...
		TCHAR str[256];
		_itoa_s(freeBytes, str, sizeof(freeBytes));
		MessageBox(NULL, str, "Function from classDLL", MB_OK);
	}	break;
